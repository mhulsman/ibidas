...
class Representor(Node):
    ...
    def TakeFrom(self, other, allow_missing=False,keep_missing=False, keep_name=False):
        return repops_multi.Take(other, self, allow_missing,keep_missing,keep_name)
